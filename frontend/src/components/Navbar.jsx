...
export default function Navbar({ darkMode, setDarkMode }) {
  ...
  const navStyle = {
    ...
    position: 'sticky', top: 0, zIndex: 1000, padding: '0 20px',
  }
  const innerStyle = {
  ...
  const getLinkStyle = (path) => ({
    ...
    color: isActive(path) ? '#fff' : darkMode ? '#aaa' : '#555',
      ...
      <nav style={navStyle}>
        <div style={innerStyle}>
          <Link to="/" style={{
            ...
            color: darkMode ? '#fff' : '#111', textDecoration: 'none',
            ...
            {user ? (
              ...
              <>
                ...
                <Link to="/register" style={{
                  ...
                  color: '#fff', padding: '8px 18px', fontWeight: '600',
                }}>Get Started</Link>
              </>
            )}
          </div>
